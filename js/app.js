...
const CEVIRI = {
  tr: {
    ...
    sss_git_metin: "SeaData nasıl çalışır, Mavi Bayrak ne demek, veriler ne sıklıkla güncelleniyor? Tüm cevaplar SSS sayfasında.",
  ...
  en: {
    ...
    sss_git_metin: "How does SeaData work, what does Blue Flag mean, how often is data updated? All the answers are on the FAQ page.",
