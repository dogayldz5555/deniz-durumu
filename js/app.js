...
const CEVIRI = {
  tr: {
    ...
    tahminimiz: "Bugün ve 7 Günlük Tahmin",
    ...
    sayfa_baslik: "Deniz Durumu ve Dalga Durumu — SeaDataWave",
    meta_aciklama: "Türkiye kıyılarında deniz durumu ve dalga durumu: anlık rüzgar, dalga yüksekliği ve 7 günlük tahmin. Haritadan bir nokta seç, denizin bugün keyifli mi yoksa dalgalı mı olduğunu öğren, sahadan gelen gerçek kullanıcı yorumlarını oku.",
    og_aciklama: "Türkiye kıyılarında anlık deniz durumu ve dalga durumu — o bölgede deniz keyifli mi yoksa dalgalı mı, hemen öğren.",
    ...
    etiket_hafif: "Deniz iyi görünüyor",
    etiket_fazla: "Orta derecede dalga var",
    etiket_tehlikeli: "Fazla dalga var",
    etiket_kisa_carsaf: "çok iyi",
    etiket_kisa_hafif: "iyi",
    etiket_kisa_fazla: "orta dalga",
    etiket_kisa_tehlikeli: "fazla dalga",
    etiket_alt_carsaf: "Dalgasız, çok az dalga var, değişebilir",
    etiket_alt_hafif: "Sadece hafif dalga var, girilebilir",
    etiket_alt_fazla: "Deniz kıyı tarafında riskli olmayabilir ama açılmak riskli olabilir",
    etiket_alt_tehlikeli: "Denize girmeniz önerilmez",
    nav_anasayfa: "Anasayfa",
    nav_iller: "İller",
    nav_veriler: "Veriler",
    nav_yorumlar: "Yorumlar",
    nav_hakkimizda: "Hakkımızda",
    nav_guvenlik: "Deniz Güvenliği",
    nav_mavi_bayrak: "Mavi Bayrak Nedir?",
    nav_veri_rehberi: "Veri Okuma Rehberi",
    nav_iletisim: "İletişim",
    nav_ruzgar_sporlari: "Rüzgar Sporları Noktaları",
    nav_bayrak_siralama: "Mavi Bayrak Sıralaması",
    nav_yuzme_sezonu: "Yüzme Sezonu Ne Zaman Başlar?",
    nav_sss: "Sıkça Sorulan Sorular",
    nav_tum_on_ek: "Tüm",
    brand_alt: "Anlık Deniz Verileri",
    footer_kesfet: "Keşfet",
    footer_rehberler: "Rehberler",
    footer_destek: "Destek",
    illerimiz_baslik: "İllerimiz",
    birim_il: "il",
    birim_ilce: "ilçe",
    birim_plaj: "plaj",
    istatistik_canli: "Canlı",
    istatistik_bolgeye_ozel_sayfa: "Bölgeye özel sayfa",
    istatistik_kiyi_ilcesi_kapsaniyor: "Kıyı ilçesi kapsanıyor",
    istatistik_mavi_bayrakli_halk_plaji: "Mavi Bayraklı halk plajı",
    istatistik_acik_meteo_veri: "Open-Meteo'dan anlık veri",
  },
  en: {
    site_baslik: "SeaDataWave",
    ...
    tahminimiz: "Today's & 7-Day Forecast",
    ...
    sayfa_baslik: "Sea Conditions & Wave Conditions — SeaDataWave",
    meta_aciklama: "Live sea conditions and wave conditions for Turkey's coasts: real-time wind, wave height and a 7-day forecast. Pick a point on the map, find out whether the sea is calm or choppy today, and read real user reports from the field.",
    og_aciklama: "Live sea conditions and wave conditions for any point on Turkey's coast — find out if it's calm or choppy before you head to the beach.",
    ...
    etiket_hafif: "Sea looks good",
    etiket_fazla: "Moderate waves",
    etiket_tehlikeli: "Rough seas",
    etiket_kisa_carsaf: "very good",
    etiket_kisa_hafif: "good",
    etiket_kisa_fazla: "moderate waves",
    etiket_kisa_tehlikeli: "rough",
    etiket_alt_carsaf: "Flat, very little wave, can change",
    etiket_alt_hafif: "Only a light wave, safe to swim",
    etiket_alt_fazla: "May be fine near shore, but risky further out",
    etiket_alt_tehlikeli: "Swimming isn't recommended",
    nav_anasayfa: "Home",
    nav_iller: "Provinces",
    nav_veriler: "Data",
    nav_yorumlar: "Comments",
    nav_hakkimizda: "About",
    nav_guvenlik: "Sea Safety",
    nav_mavi_bayrak: "What is Blue Flag?",
    nav_veri_rehberi: "Reading the Data",
    nav_iletisim: "Contact",
    nav_ruzgar_sporlari: "Wind Sports Spots",
    nav_bayrak_siralama: "Blue Flag Ranking",
    nav_yuzme_sezonu: "When Does Swimming Season Start?",
    nav_sss: "FAQ",
    nav_tum_on_ek: "All",
    brand_alt: "Live Sea Data",
    footer_kesfet: "Explore",
    footer_rehberler: "Guides",
    footer_destek: "Support",
    illerimiz_baslik: "Our Provinces",
    birim_il: "provinces",
    birim_ilce: "districts",
    birim_plaj: "beaches",
    istatistik_canli: "Live",
    istatistik_bolgeye_ozel_sayfa: "Dedicated regional page",
    istatistik_kiyi_ilcesi_kapsaniyor: "Coastal districts covered",
    istatistik_mavi_bayrakli_halk_plaji: "Blue Flag public beaches",
    istatistik_acik_meteo_veri: "Live data from Open-Meteo",
  },
};
function t(key, ...args) {
...
const MAVI_BAYRAK_PLAJLAR = [
  ...
  { ad: "Ceneviz Kale Plajı", adEn: "Ceneviz Kale Beach", lat: 41.0861, lon: 31.0925, yaricapKm: 0.3, il: "Düzce", ilce: "Akçakoca" },
  { ad: "Sevgi Plajı", adEn: "Sevgi Beach", lat: 41.2145, lon: 31.4102, yaricapKm: 0.4, il: "Zonguldak", ilce: "Karadeniz Ereğli" },
  { ad: "Kızkalesi Halk Plajı", adEn: "Kızkalesi Public Beach", lat: 36.466, lon: 34.147, yaricapKm: 0.5, il: "Mersin", ilce: "Erdemli" },
  { ad: "Susanoğlu Halk Plajı", adEn: "Susanoğlu Public Beach", lat: 36.42, lon: 34.1, yaricapKm: 0.6, il: "Mersin", ilce: "Silifke" },
  { ad: "Anamur Belediyesi Halk Plajı", adEn: "Anamur Municipal Public Beach", lat: 36.073, lon: 32.869, yaricapKm: 0.5, il: "Mersin", ilce: "Anamur" },
  { ad: "Yumurtalık Plajı", adEn: "Yumurtalık Beach", lat: 36.7724, lon: 35.7945, yaricapKm: 0.3, il: "Adana", ilce: "Yumurtalık" },
  { ad: "Cumhuriyet Mahallesi Halk Plajı", adEn: "Cumhuriyet Neighborhood Public Beach", lat: 40.981, lon: 37.944, yaricapKm: 0.6, il: "Ordu", ilce: "Altınordu" },
  { ad: "Karasu Sahil Park Halk Plajı", adEn: "Karasu Sahil Park Public Beach", lat: 41.1031, lon: 30.7123, yaricapKm: 0.3, il: "Sakarya", ilce: "Karasu" },
  { ad: "32 Evler Halk Plajı", adEn: "32 Evler Public Beach", lat: 41.0999804, lon: 30.7157799, yaricapKm: 0.3, il: "Sakarya", ilce: "Karasu" },
  { ad: "Lapseki Dalyan Belediyesi Sosyal Tesisleri Plajı", adEn: "Lapseki Dalyan Municipal Social Facilities Beach", lat: 40.3624, lon: 26.6901, yaricapKm: 0.3, il: "Çanakkale", ilce: "Lapseki" },
  { ad: "Hamzakoy Plajı", adEn: "Hamzakoy Beach", lat: 40.4141, lon: 26.6795, yaricapKm: 0.3, il: "Çanakkale", ilce: "Gelibolu" },
  { ad: "Altınova Plajı", adEn: "Altınova Beach", lat: 40.9394, lon: 27.4865, yaricapKm: 0.3, il: "Tekirdağ", ilce: "Tekirdağ Merkez" },
  { ad: "Dardanos Halk Plajı", adEn: "Dardanos Public Beach", lat: 40.0876, lon: 26.3644, yaricapKm: 0.3, il: "Çanakkale", ilce: "Çanakkale Merkez" },
  { ad: "Karabiga Belediyesi Halk Plajı", adEn: "Karabiga Municipal Public Beach", lat: 40.4024, lon: 27.3034, yaricapKm: 0.5, il: "Çanakkale", ilce: "Biga" },
];
...
const HALK_PLAJLARI = [
  ...
  { ad: "Çayağzı Halk Plajı", adEn: "Çayağzı Public Beach", lat: 41.0972, lon: 31.2106, yaricapKm: 0.3, il: "Düzce", ilce: "Akçakoca" },
  { ad: "Çuhallı Plajı", adEn: "Çuhallı Beach", lat: 41.0906, lon: 31.1404, yaricapKm: 0.3, il: "Düzce", ilce: "Akçakoca" },
  { ad: "Kapuz Plajı", adEn: "Kapuz Beach", lat: 41.4721, lon: 31.8036, yaricapKm: 0.3, il: "Zonguldak", ilce: "Zonguldak Merkez" },
  { ad: "Uzunkum Plajı", adEn: "Uzunkum Beach", lat: 41.4746, lon: 31.8082, yaricapKm: 0.3, il: "Zonguldak", ilce: "Zonguldak Merkez" },
  { ad: "Kızlar Plajı", adEn: "Kızlar Beach", lat: 41.4551, lon: 31.7669, yaricapKm: 0.3, il: "Zonguldak", ilce: "Zonguldak Merkez" },
  { ad: "Köseağzı Plajı", adEn: "Köseağzı Beach", lat: 41.3282, lon: 31.4671, yaricapKm: 0.3, il: "Zonguldak", ilce: "Karadeniz Ereğli" },
  { ad: "Büyük Liman Plajı", adEn: "Büyük Liman Beach", lat: 41.7466, lon: 32.3877, yaricapKm: 0.3, il: "Bartın", ilce: "Amasra" },
  { ad: "Küçük Liman Plajı", adEn: "Küçük Liman Beach", lat: 41.7477, lon: 32.3844, yaricapKm: 0.3, il: "Bartın", ilce: "Amasra" },
  { ad: "İnce Kum Plajı", adEn: "İnce Kum Beach", lat: 41.7361, lon: 32.3633, yaricapKm: 0.3, il: "Bartın", ilce: "Amasra" },
  { ad: "Gideros Koyu", adEn: "Gideros Bay", lat: 41.8588, lon: 32.857, yaricapKm: 0.4, il: "Kastamonu", ilce: "Cide" },
  { ad: "Gebeş Plajı", adEn: "Gebeş Beach", lat: 41.8735, lon: 32.9087, yaricapKm: 0.3, il: "Kastamonu", ilce: "Cide" },
  { ad: "Kumkapı Plajı", adEn: "Kumkapı Beach", lat: 42.02517, lon: 35.13548, yaricapKm: 0.3, il: "Sinop", ilce: "Sinop Merkez" },
  { ad: "Stad Altı Plajı", adEn: "Stad Altı Beach", lat: 42.02315, lon: 35.11839, yaricapKm: 0.3, il: "Sinop", ilce: "Sinop Merkez" },
  { ad: "Orman Kampı Plajı", adEn: "Orman Kampı Beach", lat: 42.01695, lon: 35.13338, yaricapKm: 0.3, il: "Sinop", ilce: "Sinop Merkez" },
  { ad: "Akliman Kumsalı", adEn: "Akliman Beach", lat: 42.03872, lon: 35.05133, yaricapKm: 0.3, il: "Sinop", ilce: "Sinop Merkez" },
  { ad: "Büyük Gerze Plajı", adEn: "Büyük Gerze Beach", lat: 41.9928, lon: 35.2043, yaricapKm: 0.6, il: "Sinop", ilce: "Gerze" },
  { ad: "Ayancık Sahili", adEn: "Ayancık Shore", lat: 41.94881, lon: 34.58633, yaricapKm: 0.3, il: "Sinop", ilce: "Ayancık" },
  { ad: "Ayancık Köyü Plajı", adEn: "Ayancık Village Beach", lat: 41.94756, lon: 34.60039, yaricapKm: 0.3, il: "Sinop", ilce: "Ayancık" },
  { ad: "Ali Köyü Plajı", adEn: "Ali Köyü Beach", lat: 41.9419, lon: 34.65484, yaricapKm: 0.3, il: "Sinop", ilce: "Ayancık" },
  { ad: "Demas Plajı", adEn: "Demas Beach", lat: 41.04838, lon: 37.48489, yaricapKm: 0.3, il: "Ordu", ilce: "Fatsa" },
  { ad: "Bolaman Plajı", adEn: "Bolaman Beach", lat: 41.03699, lon: 37.59231, yaricapKm: 0.3, il: "Ordu", ilce: "Fatsa" },
  { ad: "Çınarsuyu Plajı", adEn: "Çınarsuyu Beach", lat: 41.14533, lon: 37.24731, yaricapKm: 0.3, il: "Ordu", ilce: "Ünye" },
  { ad: "Yason Kilisesi Kumsalı", adEn: "Yason Church Beach", lat: 41.134, lon: 37.682, yaricapKm: 0.4, il: "Ordu", ilce: "Perşembe" },
  { ad: "Belediye Plajı", adEn: "Belediye Beach", lat: 40.917, lon: 38.326, yaricapKm: 0.5, il: "Giresun", ilce: "Giresun Merkez" },
  { ad: "Burunucu Plajı", adEn: "Burunucu Beach", lat: 40.94238, lon: 38.28688, yaricapKm: 0.5, il: "Giresun", ilce: "Bulancak" },
  { ad: "Tirebolu Plajı", adEn: "Tirebolu Beach", lat: 41.00377, lon: 38.80773, yaricapKm: 0.3, il: "Giresun", ilce: "Tirebolu" },
  { ad: "Tirebolu Uzunkum Plajı", adEn: "Tirebolu Uzunkum Beach", lat: 41.0058, lon: 38.83368, yaricapKm: 0.3, il: "Giresun", ilce: "Tirebolu" },
  { ad: "Ayasofya Plajı", adEn: "Ayasofya Beach", lat: 41.0069, lon: 39.6982, yaricapKm: 0.3, il: "Trabzon", ilce: "Ortahisar" },
  { ad: "Salacık Plajı", adEn: "Salacık Beach", lat: 41.0593, lon: 39.5284, yaricapKm: 0.3, il: "Trabzon", ilce: "Akçaabat" },
  { ad: "Kıyıcık Aile Plajı", adEn: "Kıyıcık Family Beach", lat: 40.9638, lon: 40.2969, yaricapKm: 0.3, il: "Trabzon", ilce: "Of" },
  { ad: "Kavak Camii Doğusu Plajı", adEn: "Kavak Mosque East Beach", lat: 40.9794, lon: 40.32, yaricapKm: 0.3, il: "Trabzon", ilce: "Of" },
  { ad: "Soğukpınar Barınak Önü Plajı", adEn: "Soğukpınar Harbor Beach", lat: 40.9277, lon: 40.2291, yaricapKm: 0.3, il: "Trabzon", ilce: "Of" },
  { ad: "Yalıncak Aile Plajı", adEn: "Yalıncak Family Beach", lat: 40.9858, lon: 39.8233, yaricapKm: 0.3, il: "Trabzon", ilce: "Yomra" },
  { ad: "Kaşüstü Zulu Plajı", adEn: "Kaşüstü Zulu Beach", lat: 40.9698, lon: 39.8407, yaricapKm: 0.3, il: "Trabzon", ilce: "Yomra" },
  { ad: "Absolut Beach", adEn: "Absolut Beach", lat: 40.9769, lon: 39.8335, yaricapKm: 0.3, il: "Trabzon", ilce: "Yomra" },
  { ad: "Limanköy Plajı", adEn: "Limanköy Beach", lat: 41.0765, lon: 40.6862, yaricapKm: 0.3, il: "Rize", ilce: "Çayeli" },
  { ad: "Kemeraltı Plajı", adEn: "Kemeraltı Beach", lat: 41.1297, lon: 40.7613, yaricapKm: 0.3, il: "Rize", ilce: "Çayeli" },
  { ad: "Hamidiye Plajı", adEn: "Hamidiye Beach", lat: 41.179, lon: 40.945, yaricapKm: 0.6, il: "Rize", ilce: "Pazar" },
  { ad: "Kopmuş Plajı", adEn: "Kopmuş Beach", lat: 41.4564, lon: 41.4715, yaricapKm: 0.3, il: "Artvin", ilce: "Hopa" },
  { ad: "Güngören Halk Plajı", adEn: "Güngören Public Beach", lat: 41.3292, lon: 41.2517, yaricapKm: 0.3, il: "Artvin", ilce: "Arhavi" },
  { ad: "Kıyıcık Plajı", adEn: "Kıyıcık Beach", lat: 41.3311, lon: 41.2536, yaricapKm: 0.3, il: "Artvin", ilce: "Arhavi" },
  { ad: "Kurfalı Sahil Plajı", adEn: "Kurfalı Coastal Beach", lat: 41.1409, lon: 29.8337, yaricapKm: 0.3, il: "İstanbul", ilce: "Şile" },
  { ad: "Silivri Kumluk Mevkii Halk Plajı", adEn: "Silivri Kumluk Public Beach", lat: 41.0778, lon: 28.2311, yaricapKm: 0.3, il: "İstanbul", ilce: "Silivri" },
  { ad: "Selimpaşa Sahili", adEn: "Selimpaşa Shore", lat: 41.0577, lon: 28.3449, yaricapKm: 0.3, il: "İstanbul", ilce: "Silivri" },
  { ad: "Büyükçekmece Halk Plajı", adEn: "Büyükçekmece Public Beach", lat: 41.0158, lon: 28.5907, yaricapKm: 0.3, il: "İstanbul", ilce: "Büyükçekmece" },
  { ad: "Mimarsinan Sahili", adEn: "Mimarsinan Shore", lat: 41.0134, lon: 28.5625, yaricapKm: 0.3, il: "İstanbul", ilce: "Büyükçekmece" },
  { ad: "Kefken Plajı", adEn: "Kefken Beach", lat: 41.1769, lon: 30.2323, yaricapKm: 0.3, il: "Kocaeli", ilce: "Kandıra" },
  { ad: "Kerpe Plajı", adEn: "Kerpe Beach", lat: 41.1561, lon: 30.1966, yaricapKm: 0.3, il: "Kocaeli", ilce: "Kandıra" },
  { ad: "Bağırganlı Plajı", adEn: "Bağırganlı Beach", lat: 41.1342, lon: 30.0204, yaricapKm: 0.3, il: "Kocaeli", ilce: "Kandıra" },
  { ad: "Altınkemer Plajı", adEn: "Altınkemer Beach", lat: 40.6956, lon: 29.6299, yaricapKm: 0.3, il: "Kocaeli", ilce: "Karamürsel" },
  { ad: "Kumyalı Plajı", adEn: "Kumyalı Beach", lat: 40.6986, lon: 29.6503, yaricapKm: 0.3, il: "Kocaeli", ilce: "Karamürsel" },
  { ad: "Ulaşlı Halk Plajı", adEn: "Ulaşlı Public Beach", lat: 40.7037, lon: 29.6691, yaricapKm: 0.3, il: "Kocaeli", ilce: "Gölcük" },
  { ad: "Kavaklı Sahili", adEn: "Kavaklı Shore", lat: 40.7187, lon: 29.8357, yaricapKm: 0.4, il: "Kocaeli", ilce: "Gölcük" },
  { ad: "Akasya Plajı", adEn: "Akasya Beach", lat: 40.658, lon: 29.2641, yaricapKm: 0.4, il: "Yalova", ilce: "Yalova Merkez" },
  { ad: "Çınarcık Plajı", adEn: "Çınarcık Beach", lat: 40.645, lon: 29.0908, yaricapKm: 0.3, il: "Yalova", ilce: "Çınarcık" },
  { ad: "Karaboğaz Sahili", adEn: "Karaboğaz Shore", lat: 41.1648, lon: 30.3701, yaricapKm: 0.4, il: "Sakarya", ilce: "Kaynarca" },
  { ad: "Burgaz Halk Plajı", adEn: "Burgaz Public Beach", lat: 40.3585, lon: 28.9195, yaricapKm: 0.4, il: "Bursa", ilce: "Mudanya" },
  { ad: "Tirilye Sahili", adEn: "Tirilye Shore", lat: 40.3927, lon: 28.7962, yaricapKm: 0.3, il: "Bursa", ilce: "Mudanya" },
  { ad: "Kumla Halk Plajı", adEn: "Kumla Public Beach", lat: 40.4703, lon: 29.0966, yaricapKm: 0.3, il: "Bursa", ilce: "Gemlik" },
  { ad: "Narlı Halk Plajı", adEn: "Narlı Public Beach", lat: 40.481, lon: 29.032, yaricapKm: 0.4, il: "Bursa", ilce: "Gemlik" },
  { ad: "Elit Plajı", adEn: "Elit Beach", lat: 39.5619, lon: 26.7083, yaricapKm: 0.3, il: "Çanakkale", ilce: "Ayvacık" },
  { ad: "Zeus Şelale Evleri Plajı", adEn: "Zeus Waterfall Houses Beach", lat: 39.5566, lon: 26.6881, yaricapKm: 0.3, il: "Çanakkale", ilce: "Ayvacık" },
  { ad: "Avana Plajı", adEn: "Avana Beach", lat: 39.7972, lon: 26.044, yaricapKm: 0.3, il: "Çanakkale", ilce: "Bozcaada" },
  { ad: "Çayır Koyu Plajı", adEn: "Çayır Bay Beach", lat: 39.8429, lon: 26.0307, yaricapKm: 0.3, il: "Çanakkale", ilce: "Bozcaada" },
  { ad: "Aydıncık Plajı", adEn: "Aydıncık (Kefalos) Beach", lat: 40.1445, lon: 25.9748, yaricapKm: 0.3, il: "Çanakkale", ilce: "Gökçeada" },
  { ad: "Kapıkaya Plajı", adEn: "Kapıkaya Beach", lat: 40.1039, lon: 25.8086, yaricapKm: 0.3, il: "Çanakkale", ilce: "Gökçeada" },
  { ad: "Marmaros Sahili", adEn: "Marmaros Shore", lat: 40.1994, lon: 25.764, yaricapKm: 0.3, il: "Çanakkale", ilce: "Gökçeada" },
  { ad: "Fatma Kadın Plajı", adEn: "Fatma Kadın Beach", lat: 40.5068, lon: 26.679, yaricapKm: 0.3, il: "Çanakkale", ilce: "Gelibolu" },
  { ad: "Bolayır Plajı", adEn: "Bolayır Beach", lat: 40.5458, lon: 26.7501, yaricapKm: 0.3, il: "Çanakkale", ilce: "Gelibolu" },
  { ad: "Mavi Saroz Plajı", adEn: "Mavi Saroz Beach", lat: 40.5063, lon: 26.657, yaricapKm: 0.3, il: "Çanakkale", ilce: "Gelibolu" },
  { ad: "Barbaros Topağaç Halk Plajı", adEn: "Barbaros Topağaç Public Beach", lat: 40.9297, lon: 27.4823, yaricapKm: 0.3, il: "Tekirdağ", ilce: "Tekirdağ Merkez" },
  { ad: "Değirmenaltı Halk Plajı", adEn: "Değirmenaltı Public Beach", lat: 40.9845, lon: 27.5766, yaricapKm: 0.3, il: "Tekirdağ", ilce: "Tekirdağ Merkez" },
  { ad: "Dereağzı Halk Plajı", adEn: "Dereağzı Public Beach", lat: 40.9808, lon: 27.5591, yaricapKm: 0.3, il: "Tekirdağ", ilce: "Tekirdağ Merkez" },
  { ad: "Mürefte Halk Plajı", adEn: "Mürefte Public Beach", lat: 40.6705, lon: 27.2497, yaricapKm: 0.3, il: "Tekirdağ", ilce: "Şarköy" },
  { ad: "Eriklice Köyü Halk Plajı", adEn: "Eriklice Village Public Beach", lat: 40.6393, lon: 27.187, yaricapKm: 0.3, il: "Tekirdağ", ilce: "Şarköy" },
  { ad: "Marmara Ereğlisi Halk Plajı", adEn: "Marmara Ereğlisi Public Beach", lat: 40.9727, lon: 27.956, yaricapKm: 0.3, il: "Tekirdağ", ilce: "Marmara Ereğlisi" },
  { ad: "Dallas Plajı", adEn: "Dallas Beach", lat: 40.9703, lon: 27.9213, yaricapKm: 0.3, il: "Tekirdağ", ilce: "Marmara Ereğlisi" },
  { ad: "Sultanköy Plajı", adEn: "Sultanköy Beach", lat: 41.0135, lon: 27.987, yaricapKm: 0.3, il: "Tekirdağ", ilce: "Marmara Ereğlisi" },
  { ad: "Kıyıköy Halk Plajı", adEn: "Kıyıköy Public Beach", lat: 41.6392, lon: 28.0934, yaricapKm: 0.3, il: "Kırklareli", ilce: "Vize (Kıyıköy)" },
  { ad: "Kastro Plajı", adEn: "Kastro Beach", lat: 41.5851, lon: 28.1486, yaricapKm: 0.3, il: "Kırklareli", ilce: "Vize (Kıyıköy)" },
  { ad: "Servez Plajı", adEn: "Servez Beach", lat: 41.6544, lon: 28.0879, yaricapKm: 0.3, il: "Kırklareli", ilce: "Vize (Kıyıköy)" },
  { ad: "Poliçe Plajı", adEn: "Poliçe Beach", lat: 41.7364, lon: 28.0393, yaricapKm: 0.3, il: "Kırklareli", ilce: "Vize (Kıyıköy)" },
  { ad: "Panayır İskelesi Koyu", adEn: "Panayır İskelesi Bay", lat: 41.7715, lon: 28.0187, yaricapKm: 0.3, il: "Kırklareli", ilce: "Vize (Kıyıköy)" },
  { ad: "Karaduvar Sahili", adEn: "Karaduvar Shore", lat: 36.8079, lon: 34.6907, yaricapKm: 0.3, il: "Mersin", ilce: "Mersin Merkez" },
  { ad: "Erdemli Halk Plajı", adEn: "Erdemli Public Beach", lat: 36.6085, lon: 34.3239, yaricapKm: 0.3, il: "Mersin", ilce: "Erdemli" },
  { ad: "Taşucu Plajı", adEn: "Taşucu Beach", lat: 36.3164, lon: 33.8871, yaricapKm: 0.3, il: "Mersin", ilce: "Silifke" },
  { ad: "Atayurt Plajı", adEn: "Atayurt Beach", lat: 36.38, lon: 34.069, yaricapKm: 0.4, il: "Mersin", ilce: "Silifke" },
  { ad: "Tarsus Plajı", adEn: "Tarsus Beach", lat: 36.793, lon: 34.869, yaricapKm: 0.5, il: "Mersin", ilce: "Tarsus" },
  { ad: "Çevlik Plajı", adEn: "Çevlik Beach", lat: 36.126, lon: 35.915, yaricapKm: 0.4, il: "Hatay", ilce: "Samandağ" },
  { ad: "Arsuz Atatürk Plajı", adEn: "Arsuz Atatürk Beach", lat: 36.4517, lon: 35.927, yaricapKm: 0.3, il: "Hatay", ilce: "Arsuz" },
  { ad: "Karaağaç Plajı", adEn: "Karaağaç Beach", lat: 36.5616, lon: 36.1306, yaricapKm: 0.4, il: "Hatay", ilce: "Arsuz" },
  { ad: "Büyükdere Sahili", adEn: "Büyükdere Shore", lat: 36.526, lon: 36.04, yaricapKm: 0.4, il: "Hatay", ilce: "İskenderun" },
  // Demirköy (İğneada) — Overpass, addr:district=Demirköy etiketiyle doğrulandı (2026-07-11)
  { ad: "İğneada Resort Plajı", adEn: "İğneada Resort Beach", lat: 41.8763694, lon: 27.9878479, yaricapKm: 0.3, il: "Kırklareli", ilce: "Demirköy (İğneada)" },
  { ad: "İl Özel İdaresi Kampı Plajı", adEn: "İl Özel İdaresi Kampı Beach", lat: 41.8828754, lon: 27.9963749, yaricapKm: 0.3, il: "Kırklareli", ilce: "Demirköy (İğneada)" },
  { ad: "Longoz Kampı Plajı", adEn: "Longoz Kampı Beach", lat: 41.8220649, lon: 27.9965038, yaricapKm: 0.3, il: "Kırklareli", ilce: "Demirköy (İğneada)" },
  // Kocaali — Overpass, gerçek isimli plaj node/way'leri (2026-07-11)
  { ad: "Paşalar Plajı", adEn: "Paşalar Beach", lat: 41.0757355, lon: 31.025365, yaricapKm: 0.3, il: "Sakarya", ilce: "Kocaali" },
  { ad: "Karaburun Plajı", adEn: "Karaburun Beach", lat: 41.0758939, lon: 31.0346232, yaricapKm: 0.3, il: "Sakarya", ilce: "Kocaali" },
  { ad: "Kalkın Plajı", adEn: "Kalkın Beach", lat: 41.07594, lon: 31.044287, yaricapKm: 0.3, il: "Sakarya", ilce: "Kocaali" },
  { ad: "Non Stop Beach", adEn: "Non Stop Beach", lat: 41.2457, lon: 29.0315, yaricapKm: 0.3, il: "İstanbul", ilce: "Sarıyer" },
  { ad: "Kısırkaya Plajı", adEn: "Kısırkaya Beach", lat: 41.2541, lon: 28.9704, yaricapKm: 0.3, il: "İstanbul", ilce: "Sarıyer" },
  { ad: "Karaburun Plajı", adEn: "Karaburun Beach", lat: 41.35, lon: 28.63, yaricapKm: 0.6, il: "İstanbul", ilce: "Arnavutköy" },
  { ad: "Riva Halk Plajı", adEn: "Riva Public Beach", lat: 41.224442, lon: 29.2171, yaricapKm: 0.3, il: "İstanbul", ilce: "Beykoz" },
  { ad: "Evcik Plajı", adEn: "Evcik Beach", lat: 41.4481, lon: 28.3844, yaricapKm: 0.3, il: "İstanbul", ilce: "Çatalca" },
  { ad: "Florya Güneş Plajı", adEn: "Florya Güneş Beach", lat: 40.972, lon: 28.7862, yaricapKm: 0.3, il: "İstanbul", ilce: "Bakırköy" },
  { ad: "Menekşe Plajı", adEn: "Menekşe Beach", lat: 40.9785, lon: 28.7719, yaricapKm: 0.3, il: "İstanbul", ilce: "Bakırköy" },
  { ad: "Avcılar Sahil Plajı", adEn: "Avcılar Beach", lat: 40.9812, lon: 28.7231, yaricapKm: 0.4, il: "İstanbul", ilce: "Avcılar" },
  { ad: "Başiskele Sahili", adEn: "Başiskele Beach", lat: 40.6298, lon: 29.9509, yaricapKm: 0.4, il: "Kocaeli", ilce: "Başiskele" },
  { ad: "Gebze Belediyesi Halk Plajı", adEn: "Gebze Municipal Public Beach", lat: 40.7682, lon: 29.4256, yaricapKm: 0.4, il: "Kocaeli", ilce: "Gebze" },
  { ad: "Tavşancıl Sahili", adEn: "Tavşancıl Beach", lat: 40.78, lon: 29.55, yaricapKm: 0.6, il: "Kocaeli", ilce: "Dilovası" },
  { ad: "Hersek Plajı", adEn: "Hersek Beach", lat: 40.7239, lon: 29.5046, yaricapKm: 0.4, il: "Yalova", ilce: "Altınova" },
  { ad: "Fıstıklı Plajı", adEn: "Fıstıklı Beach", lat: 40.4908, lon: 28.8934, yaricapKm: 0.3, il: "Yalova", ilce: "Armutlu" },
  { ad: "Çiftlikköy Halk Plajı", adEn: "Çiftlikköy Public Beach", lat: 40.6685, lon: 29.3135, yaricapKm: 0.3, il: "Yalova", ilce: "Çiftlikköy" },
  { ad: "Kozlu Halk Plajı", adEn: "Kozlu Public Beach", lat: 41.4448, lon: 31.7502, yaricapKm: 0.3, il: "Zonguldak", ilce: "Kozlu" },
  { ad: "Ilıksu Plajı", adEn: "Ilıksu Beach", lat: 41.408, lon: 31.6815, yaricapKm: 0.3, il: "Zonguldak", ilce: "Kozlu" },
  { ad: "Filyos Plajı", adEn: "Filyos Beach", lat: 41.57, lon: 31.93, yaricapKm: 0.6, il: "Zonguldak", ilce: "Çaycuma" },
  { ad: "İnkumu Plajı", adEn: "İnkumu Beach", lat: 41.664, lon: 32.2209, yaricapKm: 0.4, il: "Bartın", ilce: "Bartın Merkez" },
  { ad: "Abana Plajı", adEn: "Abana Beach", lat: 41.9808, lon: 34.0096, yaricapKm: 0.3, il: "Kastamonu", ilce: "Abana" },
  { ad: "Harmason Plajı", adEn: "Harmason Beach", lat: 41.9799, lon: 33.9872, yaricapKm: 0.3, il: "Kastamonu", ilce: "Abana" },
  { ad: "Yakaören Sahili", adEn: "Yakaören Beach", lat: 41.9608, lon: 34.1708, yaricapKm: 0.4, il: "Kastamonu", ilce: "Bozkurt" },
  { ad: "Uzunkum Plajı", adEn: "Uzunkum Beach", lat: 41.9467, lon: 34.3497, yaricapKm: 0.4, il: "Kastamonu", ilce: "Doğanyurt" },
  { ad: "Ginolu Koyu Plajı", adEn: "Ginolu Bay Beach", lat: 41.9656, lon: 34.1649, yaricapKm: 0.4, il: "Kastamonu", ilce: "Çatalzeytin" },
  { ad: "Türkeli Plajı", adEn: "Türkeli Beach", lat: 41.9484, lon: 34.337, yaricapKm: 0.4, il: "Sinop", ilce: "Türkeli" },
  { ad: "Canik Sahili", adEn: "Canik Beach", lat: 41.29, lon: 36.36, yaricapKm: 0.5, il: "Samsun", ilce: "Canik" },
  { ad: "Tekkeköy Sahili", adEn: "Tekkeköy Beach", lat: 41.2537, lon: 36.4989, yaricapKm: 0.3, il: "Samsun", ilce: "Tekkeköy" },
  { ad: "Pamucak Sahili", adEn: "Pamucak Beach", lat: 37.9402, lon: 27.2706, yaricapKm: 0.4, il: "İzmir", ilce: "Selçuk" },
  { ad: "Ağapark Plajı", adEn: "Ağapark Beach", lat: 38.845, lon: 26.972, yaricapKm: 0.4, il: "İzmir", ilce: "Aliağa" },
  { ad: "Şakran Plajı", adEn: "Şakran Beach", lat: 38.885, lon: 27.065, yaricapKm: 0.4, il: "İzmir", ilce: "Aliağa" },
  { ad: "Karadere Plajı", adEn: "Karadere Beach", lat: 36.333, lon: 29.267, yaricapKm: 0.4, il: "Muğla", ilce: "Seydikemer" },
  { ad: "Kumluova Plajı", adEn: "Kumluova Beach", lat: 36.337, lon: 29.304, yaricapKm: 0.4, il: "Muğla", ilce: "Seydikemer" },
  { ad: "Eceabat Halk Plajı", adEn: "Eceabat Public Beach", lat: 40.188, lon: 26.357, yaricapKm: 0.4, il: "Çanakkale", ilce: "Eceabat" },
  { ad: "Denizkent Halk Plajı", adEn: "Denizkent Public Beach", lat: 40.2968, lon: 27.5315, yaricapKm: 0.5, il: "Balıkesir", ilce: "Gönen" },
  { ad: "Karacabey Kurşunlu Halk Plajı", adEn: "Karacabey Kurşunlu Public Beach", lat: 40.3965, lon: 28.2894, yaricapKm: 0.5, il: "Bursa", ilce: "Karacabey" },
  { ad: "Mavi Dünya Halk Plajı", adEn: "Mavi Dünya Public Beach", lat: 40.974, lon: 38.0268, yaricapKm: 0.5, il: "Ordu", ilce: "Gülyalı" },
  { ad: "Uluburun Plajı", adEn: "Uluburun Beach", lat: 40.9718, lon: 38.623, yaricapKm: 0.3, il: "Giresun", ilce: "Keşap" },
  { ad: "Eğrice Plajı", adEn: "Eğrice Beach", lat: 40.9511, lon: 38.1553, yaricapKm: 0.4, il: "Giresun", ilce: "Piraziz" },
  { ad: "Eynesil Kalesi Plajı", adEn: "Eynesil Castle Beach", lat: 41.0784, lon: 39.1622, yaricapKm: 0.4, il: "Giresun", ilce: "Eynesil" },
  { ad: "Beşikdüzü Belediye Plajı", adEn: "Beşikdüzü Municipal Beach", lat: 41.0517, lon: 39.2313, yaricapKm: 0.5, il: "Trabzon", ilce: "Beşikdüzü" },
  { ad: "Çarşıbaşı Belediye Plajı", adEn: "Çarşıbaşı Municipal Beach", lat: 41.0822, lon: 39.3811, yaricapKm: 0.5, il: "Trabzon", ilce: "Çarşıbaşı" },
  { ad: "Voha Plajı", adEn: "Voha Beach", lat: 40.9199, lon: 40.0865, yaricapKm: 0.4, il: "Trabzon", ilce: "Sürmene" },
  { ad: "Arsin Sahili", adEn: "Arsin Beach", lat: 40.9539, lon: 39.9372, yaricapKm: 0.5, il: "Trabzon", ilce: "Arsin" },
  { ad: "Sarayköy Plajı", adEn: "Sarayköy Beach", lat: 41.0233, lon: 40.3827, yaricapKm: 0.3, il: "Rize", ilce: "İyidere" },
  { ad: "Kemalpaşa Plajı", adEn: "Kemalpaşa Beach", lat: 41.4831, lon: 41.5242, yaricapKm: 0.3, il: "Artvin", ilce: "Kemalpaşa" },
  { ad: "Finike Belediyesi Kadınlar Plajı", adEn: "Finike Municipal Women's Beach", lat: 36.2832636, lon: 30.1504135, yaricapKm: 0.3, il: "Antalya", ilce: "Finike" },
  { ad: "Gökliman Plajı", adEn: "Gökliman Beach", lat: 36.2789958, lon: 30.1403086, yaricapKm: 0.3, il: "Antalya", ilce: "Finike" },
  { ad: "Kundu Halk Plajı", adEn: "Kundu Public Beach", lat: 36.8526982, lon: 30.8731348, yaricapKm: 0.3, il: "Antalya", ilce: "Aksu" },
  { ad: "Gümüşkum Plajı", adEn: "Gümüşkum Beach", lat: 36.7227452, lon: 34.5005695, yaricapKm: 0.3, il: "Mersin", ilce: "Mezitli" },
  { ad: "Aydıncık Halk Plajı", adEn: "Aydıncık Public Beach", lat: 36.1536, lon: 33.3539, yaricapKm: 0.4, il: "Mersin", ilce: "Aydıncık" },
  { ad: "Bozyazı Halk Plajı", adEn: "Bozyazı Public Beach", lat: 36.0999847, lon: 32.9392585, yaricapKm: 0.4, il: "Mersin", ilce: "Bozyazı" },
  { ad: "İncirli Halk Plajı", adEn: "İncirli Public Beach", lat: 36.8902147, lon: 35.9446141, yaricapKm: 0.3, il: "Adana", ilce: "Ceyhan" },
  { ad: "Payas Halk Plajı", adEn: "Payas Public Beach", lat: 36.7594, lon: 36.1969, yaricapKm: 0.4, il: "Hatay", ilce: "Payas" },
  { ad: "Dörtyol Belediyesi Aile Halk Plajı", adEn: "Dörtyol Municipal Family Public Beach", lat: 36.8207763, lon: 36.1760386, yaricapKm: 0.3, il: "Hatay", ilce: "Dörtyol" },
  { ad: "Burnaz Plajı", adEn: "Burnaz Beach", lat: 36.9265, lon: 36.0217, yaricapKm: 0.5, il: "Hatay", ilce: "Erzin" },
];
