...
const CEVIRI = {
  tr: {
    ...
    sayfa_baslik: "SeaData — Bugün Deniz Nasıl?",
    meta_aciklama: "Türkiye kıyılarında anlık rüzgar ve dalga durumu. Haritadan bir nokta seç, denizin bugün keyifli mi yoksa dalgalı mı olduğunu öğren, sahadan gelen gerçek kullanıcı yorumlarını oku.",
    og_aciklama: "Haritadan seçtiğin herhangi bir noktada anlık rüzgar ve dalga durumunu öğren.",
    seo_baslik: "Türkiye kıyılarında deniz durumu",
    seo_metin: "Bu sayfa, Karadeniz, Marmara, Ege ve Akdeniz kıyılarındaki her noktada (Samsun, Atakum, Trabzon, Sinop, İstanbul, İzmir, Antalya ve diğer tüm sahil bölgeleri dahil) anlık rüzgar hızı, rüzgar yönü, dalga yüksekliği ve dalga periyodu verisini gösterir. Haritada herhangi bir sahil noktasına tıklayarak o bölgede denize girmenin bugün keyifli mi, yoksa dalgalı mı olacağını öğrenebilir, aynı zamanda sahilde bulunan diğer kullanıcıların gerçek zamanlı yorumlarını okuyabilirsin.",
    sss_baslik: "Sıkça sorulan sorular",
    sss_s1_soru: "Deniz bugün nasıl?",
    sss_s1_cevap: "Haritadan bir noktaya tıkla — SeaData o an için rüzgar ve dalga verisine dayanan anlık bir tahmin gösterir (Mükemmel, İyi, Orta, Kötü veya Tehlikeli). Aynı kartta, o bölgede daha önce bulunan kullanıcıların gerçek gözlemlerini de görebilirsin.",
    sss_s2_soru: "Deniz yarın nasıl olacak?",
    sss_s2_cevap: "Kart üzerindeki ok işaretlerine basarak ya da kartı kaydırarak sonraki günlere geçebilirsin — her gün için ayrı bir tahmin, saat saat gösterilir.",
    sss_s3_soru: "Deniz kaç gün sonrasına kadar tahmin ediliyor?",
    sss_s3_cevap: "Bugün dahil, önümüzdeki 1 hafta (7 gün) için tahmin sunuyoruz.",
    sss_s4_soru: "Deniz dalgalı mı, sakin mi nasıl anlaşılır?",
    sss_s4_cevap: "SeaData, rüzgar hızı, dalga yüksekliği ve dalga periyodunu birlikte değerlendirip 5 kademeli bir sonuç üretir: Mükemmel (çarşaf gibi), İyi, Orta, Kötü, Tehlikeli. Kıyının açık deniz mesafesine (fetch) göre eşikler otomatik ayarlanır — bir koyda \"iyi\" sayılan dalga, açık kıyıda \"orta\" sayılabilir.",
    sss_s5_soru: "Deniz durumu tahmini ne kadar doğru?",
    sss_s5_cevap: "Tahminler Open-Meteo'nun canlı rüzgar/dalga verisine ve kıyı şeklinin gerçek zamanlı analizine dayanır. Buna ek olarak, sahadan (o an oradaki kullanıcılardan) gelen gerçek gözlemleri de aynı ekranda gösteriyoruz, böylece tahmin ile gerçek durumu karşılaştırabilirsin.",
    sss_s6_soru: "SeaData hangi kıyılarda çalışıyor?",
    sss_s6_cevap: "Türkiye'nin Karadeniz, Marmara, Ege ve Akdeniz kıyılarındaki her noktada — haritada tıkladığın herhangi bir sahil konumu için çalışır, sadece belirli şehirlerle sınırlı değildir.",
  ...
  en: {
    ...
    sayfa_baslik: "SeaData — What's the sea like today?",
    meta_aciklama: "Live wind and wave conditions on Turkey's coasts. Pick a point on the map, find out whether the sea is calm or choppy today, and read real user reports from the field.",
    og_aciklama: "Find out the live wind and wave conditions for any point you pick on the map.",
    seo_baslik: "Sea conditions on Turkey's coasts",
    seo_metin: "This page shows live wind speed, wind direction, wave height and wave period for any point along the Black Sea, Marmara, Aegean and Mediterranean coasts of Turkey (including Samsun, Atakum, Trabzon, Sinop, Istanbul, Izmir, Antalya and every other coastal area). Tap any coastal point on the map to find out whether the sea will be pleasant or choppy today, and read real-time comments from other users at that spot.",
    sss_baslik: "Frequently asked questions",
    sss_s1_soru: "What's the sea like today?",
    sss_s1_cevap: "Tap a point on the map — SeaData shows an instant estimate based on current wind and wave data (Excellent, Good, Fair, Poor, or Dangerous). The same card also shows real observations from other users who were recently at that spot.",
    sss_s2_soru: "What will the sea be like tomorrow?",
    sss_s2_cevap: "Use the arrow buttons on the card, or swipe it, to move to the next days — each day gets its own hour-by-hour forecast.",
    sss_s3_soru: "How many days ahead is the forecast?",
    sss_s3_cevap: "We provide a forecast for the next 1 week (7 days), including today.",
    sss_s4_soru: "How do you know if the sea is choppy or calm?",
    sss_s4_cevap: "SeaData combines wind speed, wave height and wave period into a 5-level result: Excellent (flat calm), Good, Fair, Poor, Dangerous. Thresholds automatically adjust to the coastline's exposure to open water (fetch) — a wave rated \"Good\" in a sheltered cove might be \"Fair\" on an open coast.",
    sss_s5_soru: "How accurate is the sea condition forecast?",
    sss_s5_cevap: "Forecasts are based on Open-Meteo's live wind/wave data and a real-time analysis of the coastline shape. We also show real observations from users currently at that location on the same screen, so you can compare the forecast with the actual situation.",
    sss_s6_soru: "Which coasts does SeaData cover?",
    sss_s6_cevap: "Every point along Turkey's Black Sea, Marmara, Aegean and Mediterranean coasts — it works for any coastal spot you tap on the map, not just specific cities.",
