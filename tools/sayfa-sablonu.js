...
<div id="app">
  ...
  <div class="ana-ekrana-ekle-banner" id="ana-ekrana-ekle-banner" style="display:none;" role="button" tabindex="0">
    ...
    <span data-i18n="ana_ekrana_ekle_metin">Uygulama gibi kullanmak için ana ekrana ekle</span>
    <button type="button" class="kapat-btn" id="ana-ekrana-ekle-kapat" data-i18n-aria="kapat" aria-label="Kapat">×</button>
  </div>
  <div class="ana-ekrana-ekle-ipucu" id="ana-ekrana-ekle-ipucu" style="display:none;">
    <div id="ana-ekrana-ekle-ipucu-metin"></div>
    <button type="button" class="kapat-btn" id="ana-ekrana-ekle-ipucu-kapat" data-i18n-aria="kapat" aria-label="Kapat" style="margin-top:8px;">×</button>
  </div>
  ...
  <div class="legend-row">
    <div class="legend">
      <span><span class="dot" style="background:#1D7FC2"></span><span data-i18n="durum_carsaf">Mükemmel</span></span>
      <span><span class="dot" style="background:#1FA35C"></span><span data-i18n="durum_iyi">İyi</span></span>
      <span><span class="dot" style="background:#DBAE00"></span><span data-i18n="durum_hafif">Orta</span></span>
  ...
  <div class="gb-section" id="gb-section" style="display:none;">
    ...
    <div class="gb-buttons">
      <button class="gb-btn" data-val="carsaf"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="3" y1="12" x2="21" y2="12"/></svg><span data-i18n="durum_carsaf">Mükemmel</span></button>
      <button class="gb-btn" data-val="iyi"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg><span data-i18n="durum_iyi">İyi</span></button>
    ...
    <div class="gb-input-row" id="gb-input-row" style="display:none;">
      <input type="text" id="gb-note" data-i18n-placeholder="not_placeholder" placeholder="İsteğe bağlı not (örn. dip akıntısı var)" />
      <button class="gb-send" id="gb-send" data-i18n-aria="gonder" aria-label="Gönder">
...
<div id="yan-panel">
  <div class="yan-panel-card">
    <p class="yan-panel-title" data-i18n="yan_panel_baslik">Denize girilen yerler</p>
    <p class="yan-panel-sub" data-i18n="yan_panel_alt">Son 2 saatte yorum alan noktalar, çoğunluk görüşüne göre</p>
    <div id="yan-panel-liste"></div>
  </div>
</div>
</div>

<!-- Siteyi değerlendirme formu + kullanıcı yorumları — en altta, tam genişlik, grid'in dışında -->
...
<!-- Kullanıcı yorumları — tam genişlik, grid'in dışında -->
...
<div style="max-width:1100px;margin:0 auto;padding:0 20px 32px;text-align:center;">
  <a href="/gizlilik-politikasi.html" data-i18n="gizlilik_politikasi_link" style="font-size:12px;color:var(--footnote-text);">Gizlilik Politikası</a>
</div>
